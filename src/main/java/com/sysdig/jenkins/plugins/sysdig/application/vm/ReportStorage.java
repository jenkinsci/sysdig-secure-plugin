...
public interface ReportStorage {
  void savePolicyReport(ScanResult scanResult, PolicyEvaluationReport report) throws IOException, InterruptedException;

  void saveVulnerabilityReport(ScanResult scanResult) throws IOException, InterruptedException;
