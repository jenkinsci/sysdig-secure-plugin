...
public class Result implements Serializable {
  ...
  private List<AcceptedRisk> riskAcceptanceDefinitions;
  ...
  public Optional<List<AcceptedRisk>> getRiskAcceptanceDefinitions() {
    return Optional.ofNullable(riskAcceptanceDefinitions);
  }

  public void setRiskAcceptanceDefinitions(List<AcceptedRisk> riskAcceptanceDefinitions) {
