...
class PolicyEvaluationSummarySerializerTest {
    ...
    void testSerializeEmptySummary() {
        ...
        // Then
        JsonElement expectedJson = JsonParser.parseString("{" + "\"header\":[{"
    ...
    void testSerializeSummaryWithLines() {
        ...
        assertEquals(
                expectedJson, jsonElement, "Serialized JSON does not match expected output for a summary with lines");
    }
}
