...
class ScanResultDiffTest {
    ...
    void testScanResultDiff() {
        ...
        Vulnerability vuln1 = oldScanResult.addVulnerability("CVE-2021-0001", Severity.High, new Date(), null, false, null);
        Vulnerability vuln2 = oldScanResult.addVulnerability("CVE-2021-0002", Severity.Medium, new Date(), null, false, null);

        ScanResult newScanResult = new ScanResult(null, null, null, null, null, null, null, null, null);
        Vulnerability vuln3 = newScanResult.addVulnerability("CVE-2021-0002", Severity.Medium, new Date(), null, false, null);
