...
class PolicyEvaluationReportSerializerTest {
    ...
    void testSerializeEmptyReport() {
        ...
        // Then
        assertEquals(
                JsonParser.parseString("{}"), jsonElement, "Expected serialized JSON to be empty for an empty report");
    }
    ...
    void testSerializeReportWithResults() {
        ...
        Stream.of(
                        new PolicyEvaluationReportLine(
                                "image-1",
                                "repo:tag",
                                "trigger-1",
                                "gate-1",
